...
Any proven or suspected malfunction should be traced in a bug report, the latter being an issue in the GRIDR github repository.
...
* The incriminated command line, python or rust function
* The input and output context configurations and files if any
...
The Merge Request will be merged into main after being reviewed by GRIDR steering committee (core committers) composed of:
* Arnaud Kelbert (CNES)

Only the members of this committee can merge into main.
