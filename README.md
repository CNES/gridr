...
[![minimum rustc 1.89](https://img.shields.io/badge/rustc-1.89+-blue?logo=rust)](https://rust-lang.github.io/rfcs/2495-min-rust-version.html)
...
- spatial resampling :
    - grid based :
        ...
        - exact radiometric interpolation with internal functions (nearest neighbor, linear, cubic, spline (N/A yet) 
        - radiometric interpolation with internal tabulated functions (N/A yet)
        - radiometric interpolation using an external kernel (N/A yet)
