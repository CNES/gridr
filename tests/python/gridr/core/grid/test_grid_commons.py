...
MAKEGRID2Dx00_WINDOW = (
    ((4, 3), (0, 0.5), (3, 1), np.array([(2, 3), (1, 2)])),
    ((2, 2), (6, 1.5), (3, 1)),
)
...
MAKEGRID2Dx00_COORDS_WINDOW = (
    ...
    (np.array([[1.5, 2.5], [1.5, 2.5]]), np.array([[6.0, 6.0], [9.0, 9.0]])),
)
...
class TestGridCommons:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                (MAKEGRID2Dx00_COORDS_WINDOW[0][0], None, None, None),
                MAKEGRID2Dx00_COORDS_WINDOW[0][0],
                6,
            ),
    ...
    def test_check_grid_coords_definition(self, data, expected, testing_decimal):
        ...
        try:
            ...
            if expected_out is not None:
                ...
                np.testing.assert_array_almost_equal(
                    grid_coords_out[0], expected_out[0], decimal=testing_decimal
                )
                np.testing.assert_array_almost_equal(
                    grid_coords_out[1], expected_out[1], decimal=testing_decimal
                )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ((1, 1), np.array([[2, 10], [3, 5]])),
                (np.array([[2, 10], [3, 5]]), np.array([[0, 8], [0, 2]])),
                6,
            ),
            (
                ((3, 1), np.array([[2, 10], [3, 5]])),
                (np.array([[0, 4], [3, 5]]), np.array([[2, 10], [0, 2]])),
                6,
            ),
            (
                ((3, 1), np.array([[5, 6], [3, 5]])),
                (np.array([[1, 2], [3, 5]]), np.array([[2, 3], [0, 2]])),
                6,
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ((1, 1), np.array([[2, 10], [3, 5]]), (5, 20)),
                (np.array([[2, 4], [3, 5]]), np.array([[0, 2], [0, 2]])),
                6,
            ),
            (
                ((1, 1), np.array([[2, 10], [3, 5]]), (20, 4)),
                (np.array([[2, 10], [3, 3]]), np.array([[0, 8], [0, 0]])),
                6,
            ),
            (
                ((3, 1), np.array([[2, 10], [3, 5]]), (20, 20)),
                (np.array([[0, 4], [3, 5]]), np.array([[2, 10], [0, 2]])),
                6,
            ),
            (
                ((3, 1), np.array([[2, 10], [3, 5]]), (2, 20)),
                (np.array([[0, 1], [3, 5]]), np.array([[2, 3], [0, 2]])),
                6,
            ),
            (
                ((3, 1), np.array([[3, 3], [3, 5]]), (20, 20)),
                (np.array([[1, 2], [3, 5]]), np.array([[0, 0], [0, 2]])),
                6,
            ),  # test the grid_win > 1
            (
                ((3, 1), np.array([[3, 3], [3, 5]]), (2, 20)),
                (np.array([[0, 1], [3, 5]]), np.array([[3, 3], [0, 2]])),
                6,
            ),  # test backward shift
            (
                ((3, 1), np.array([[5, 6], [3, 5]]), (20, 20)),
                (np.array([[1, 2], [3, 5]]), np.array([[2, 3], [0, 2]])),
                6,
            ),
        ],
