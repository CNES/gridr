...
from gridr.core.grid.grid_rasterize import GridRasterizeAlg, ShapelyPredicate
...
INPUT_CHECK_009d = (
    (
        ...
        (
            shapely.geometry.Polygon([(1.5, 1.5), (3.5, 1.5), (3.5, 4.5), (1.5, 4.5)]),
            shapely.geometry.Polygon([(2.5, 2.5), (2.5, 3.5), (3.5, 3.5), (3.5, 2.5)]),
        ),  # geometry_pair
        None,  # mask_in
        None,  # mask_in_target_win
        None,  # mask_in_resolution
...
INPUT_CHECK_010 = (
    (
        ...
        (
            None,
            shapely.geometry.Polygon([(0.0, 0.0), (6.0, 0.0), (6.0, 5.0), (0.0, 5.0)]),
        ),  # geometry_pair
        None,  # mask_in
        None,  # mask_in_target_win
        None,  # mask_in_resolution
...
INPUT_CHECK_015 = (
    (
        ...
        np.array(
            [
                [V, V - 0.1, V - 0.01, V - 0.001, V - 0.0001, V],
                [I, I, I, I, I, I],
                [I, I, I, I, I, I],
...
INPUT_CHECK_016 = (
    (
        ...
        None,  # geometry_origin
        None,  # geometry_pair
        np.array([[V, V, V], [V, I, V], [V, I, I], [V, V, V]]),  # mask_in
        None,  # mask_in_target_win
    ...
    def test_build_mask(self, data, expected, testing_decimal):
        ...
        try:
            mask = build_mask(
                ...
                mask_in=mask_in,
                mask_in_target_win=mask_in_target_win,
