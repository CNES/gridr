...
class TestArrayWindow:
    ...
    @pytest.mark.parametrize("data, expected", [
            ...
            ((ARRAY_F32_00, 0, ARRAY_F32_00_val_true, None, ARRAY_COND_U8, ARRAY_F32_00_val_cond), ARRAY_F32_00_expected_cond),
            ((ARRAY_F64_00, 0, ARRAY_F64_00_val_true, None, ARRAY_COND_U8, ARRAY_F64_00_val_cond), ARRAY_F64_00_expected_cond),
    ...
    def test_array_replace(self, data, expected, win):
        ...
        if window is not None:
            ...
            win_slice=(slice(WIN_00[0][0], WIN_00[0][1]+1), slice(WIN_00[1][0], WIN_00[1][1]+1))
            try:
        ...
        try:
            array_replace(array_copy, val_cond, val_true, val_false, array_cond, array_val_cond, window)
