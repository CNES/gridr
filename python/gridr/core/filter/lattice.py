...
class Lattice2d(object):
    ...
    @classmethod
    def get_dual_domain(cls,
            lattice2d: 'Lattice2d') -> Domain:
        """
    ...
    @classmethod
    def get_dual_domain_lattice(cls,
            lattice2d: 'Lattice2d') -> 'Lattice2d':
        r"""
    ...
    @classmethod
    def gaussian_lattice_reduction(cls,
            lattice2d: 'Lattice2d',
            itermax: int = 100,
            ) -> 'Lattice2d':
        ...
        1.  If :math:`\|\mathbf{v}_2\| < \|\mathbf{v}_1\|`, swap :math:`\mathbf{v}_1` and :math:`\mathbf{v}_2`.
        
        2.  Compute the projection scalar :math:`m` : :math:`m = \lfloor \frac{\mathbf{v}_1 \cdot \mathbf{v}_2}{\mathbf{v}_1 \cdot \mathbf{v}_1} \rfloor`
        
        3.  If :math:`m = 0`, return the original basis vectors :math:`\mathbf{v}_1` and :math:`\mathbf{v}_2`.
        
        4.  Replace :math:`\mathbf{v}_2` with :math:`\mathbf{v}_2 - m \mathbf{v}_1`
        
        5.  Repeat the process until convergence or until the vectors are orthogonal or `itermax` is reached
